<template>
  <header
    class="sticky top-0 opacity-90 flex w-full bg-gradient-to-r from-neutral-300 via-white to-neutral-200 border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
