<template>
  <div
    ...
    <div class="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
      <div class="w-full">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Sales Activity</h3>
...
const series = ref([
  ...
  {
    name: 'Inquiry',
    data: [50, 90, 20, 90, 25, 10, 20, 102, 112, 142, 110, 130],
  },
  {
    name: 'Inquiry lost',
    data: [10, 50, 10, 70, 55, 70, 30, 122, 162, 112, 152, 136],
  }
])
