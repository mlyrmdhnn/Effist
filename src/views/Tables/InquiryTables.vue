            ...
            <tbody>
              <tr class="border-b dark:border-gray-700" v-for="(d, i) in hasil" :key="i">
                <th scope="row" class="px-4 py-3 font-medium text-gray-900  dark:text-white">{{
                  d.product_type }}
                  20&#34;</th>
                <td class="px-4 py-3">{{ d.building }}</td>
                ...
                <td class="px-4 py-2">{{ d.last_update }}</td>
                <td class="px-4 py-2">Create CIF | Update | Send Introduction | Transfer Inquiry | Delete Inquiry &
                  Funnel | Delete Inquiry </td>
              </tr>
